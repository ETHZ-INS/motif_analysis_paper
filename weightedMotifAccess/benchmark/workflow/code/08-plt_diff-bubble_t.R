...
d$method <- factor(d$method, c("origin.limma-voom",
    "origin.chromVAR.limma",
    "origin.betterChromVAR",
    "weight.limma-voom",
    "weight.limma-voom_motifWeights",
    "origin.betterChromVAR.FL",
    "origin.chromVAR",
    "origin.bbChromVAR",
    "origin.bbChromVAR_masking",
    "inserts.limma"),
    c("raw crossprod", "chromVAR.limma", "betterChromVAR",
        "weighted counts", "weights.matches", "betterChromVAR(+FL)", "chromVAR.differentialDeviations",
        "kNN-betterChromVAR(+FL)", "kNN-betterChromVAR(+FL)_masking",
        "insertion models"))
o <- d
...
cols <- c(
    ...
    "chromVAR.differentialDeviations" = "#9ECAE1",
    "chromVAR.limma"     = "#6BAED6",
    "betterChromVAR"     = "#4292C6",
    "betterChromVAR(+FL)"  = "#08519C",
    "kNN-betterChromVAR(+FL)" = "#08306B",
    "kNN-betterChromVAR(+FL)_masking" = "black",
    "weighted counts"    = "#E7298A",
    "weights.matches" = "#F9A8D4",
    "insertion models"   = "#66A61E"
)

labels <- c(
    "raw crossprod"      = "Raw crossprod",
    "chromVAR.differentialDeviations" = "chromVAR.differentialDeviations (GC +\nenrichment)",
    "chromVAR.limma"     = "chromVAR.limma (GC + enrichment)",
    "betterChromVAR"     = "betterChromVAR (GC + enrichment)",
    "betterChromVAR(+FL)"  = "betterChromVAR(+FL) (GC + FL + enrichment)",
    "kNN-betterChromVAR(+FL)" = "kNN-betterChromVAR(+FL) (GC + FL + enrichment)",
    "kNN-betterChromVAR(+FL)_masking" = "kNN-betterChromVAR(+FL)_masking",
    "weighted counts"    = "weighted counts (GC + FL + enrichment)",
    "insertion models"   = "insertion models (GC + FL + enrichment)"
)
